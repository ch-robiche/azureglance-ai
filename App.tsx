    ...
    <div className="flex h-screen w-screen bg-slate-950 text-slate-200 overflow-hidden">
      ...
      <aside className="w-16 md:w-20 flex flex-col items-center py-6 bg-slate-900 border-r border-slate-800 z-10">
        ...
        <nav className="flex flex-col gap-6 w-full">
          ...
          <button
            onClick={() => setCurrentView(View.COST)}
            className={`p-3 rounded-lg mx-2 transition-all ${currentView === View.COST ? 'bg-blue-500/20 text-blue-400' : 'text-slate-500 hover:bg-slate-800 hover:text-slate-300'}`}
            title="Cost Analysis"
          >
          ...
          <button
            ...
            className={`p-3 rounded-lg mx-2 transition-all ${currentView === View.SECURITY ? 'bg-blue-500/20 text-blue-400' : 'text-slate-500 hover:bg-slate-800 hover:text-slate-300'}`}
            title="Security"
          >
